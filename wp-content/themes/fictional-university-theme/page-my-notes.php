    ...
    <div class="container container--narrow page-section">
      ...
      <div class="create-note">
          ...
          <span class="note-limit-message">
            Note limit reached. You must delete a note before adding a new one.
          </span>
        </div>
      ...
      <ul class="min-list link-list" id="my-notes">
        <?php
          ...
          while($userNotes->have_posts()) {
            $userNotes->the_post();?>
            <li data-id="<?php wp_strip_all_tags(the_ID()); ?>">
              ...
              <textarea readonly class="note-body-field">
                  <?php echo esc_attr(wp_strip_all_tags(get_the_content())); ?></textarea>
